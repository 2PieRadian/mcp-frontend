...
export default function SignupForm() {
  ...
  return (
    <div className="login-form flex justify-between items-stretch gap-[20px] [@media(max-width:959px)]:mt-0 [@media(min-width:960px)]:mt-[20px] mb-[80px] [@media(max-width:959px)]:mb-[60px] rounded-lg [@media(max-width:959px)]:flex-1 [@media(max-width:959px)]:items-center">
