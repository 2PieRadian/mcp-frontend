          ...
          <div className="flex items-center gap-[15px] shrink-0">
            ...
            {user ? (
              ...
              <Link
                ...
                className={
                  isLanding
                    ? "rounded-full border border-[#0D635C] bg-[#0F766E] px-[14px] sm:px-[20px] py-[6px] text-[13px] sm:text-[15px] font-medium text-white shadow-[0_6px_20px_-4px_rgba(15,118,110,0.45)] transition-all duration-200 hover:-translate-y-0.5 hover:bg-[#0D635C] hover:shadow-[0_10px_28px_-6px_rgba(15,118,110,0.5)]"
