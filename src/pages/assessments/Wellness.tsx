...
export default function Wellness() {
  ...
  return (
    <>
      <Helmet>
        <title>Wellness Self-Assessment | MindCurePath Expert-Verified Health Insights</title>
        <meta name="description" content="Take MindCurePath wellness self-reflections to explore emotional, relationship, lifestyle, and mind-body patterns with supportive, non-diagnostic guidance." />
        <link href="https://mindcurepath.com/assessments/wellness" rel="canonical" />
        <meta property="og:title" content="Wellness Self-Assessment | MindCurePath" />
        <meta property="og:description" content="Discover wellness reflection tools across anxiety, mood, attention, relationships, stress, lifestyle, and mind-body balance." />
        <meta property="og:url" content="https://mindcurepath.com/assessments/wellness" />
      </Helmet>
        ...
        <div className="max-w-[1000px] mx-auto py-[clamp(2rem,5vw,4rem)]">
          <div className="text-center mb-[clamp(2rem,5vw,4rem)]">
            ...
            >
              ...
              <br />
              <span className="text-[#44666C]">{t("wellnessHeaderTitleLine2")}</span>
            </h1>
