  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Take MindCurePath education self-reflections to explore study habits, career clarity, exam preparation, guidance readiness, and self-learning patterns."
        />
        <link
        ...
        <meta
          ...
          content="Discover education reflection tools across academic habits, career path clarity, mentoring, exam preparation, and self-learning."
        />
        <meta
          property="og:url"
