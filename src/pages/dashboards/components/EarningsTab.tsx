  ...
  return (
    <section className="bg-[hsl(0,0%,97%)] shadow-m rounded-[16px] sm:rounded-[20px] p-[16px] sm:p-[24px]">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-[16px]">
        <div className="bg-linear-to-br from-green-50 to-green-100 rounded-[12px] p-[20px] border border-green-200">
        ...
        <div className="bg-linear-to-br from-blue-50 to-blue-100 rounded-[12px] p-[20px] border border-blue-200">
